...
- **Status line**: **`judge_keyword_line`** (SUCCESS / FAILURE) + **emoji** + **metric strip** + **`judge_summary`** + **💡 `judge_why_matters`** + short **`confidence_strip`**, then `episode_id` / outcome — see root README.
