...
The graphs below show the reward curve across training steps after applying all five fixes. The key signal is **reward/std** — when it is above 0.05, GRPO has a real gradient. When it is zero, the model cannot update.

> *See `assets/graphs/` for full resolution training curves.*

![Reward Mean over Training Steps](assets/graphs/reward_mean.png)
![Reward Std over Training Steps](assets/graphs/reward_std.png)
![Loss over Training Steps](assets/graphs/loss.png)
